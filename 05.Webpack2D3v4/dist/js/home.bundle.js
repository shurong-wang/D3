...
/******/ 	var hotCurrentHash = "94c9dbaeaee27216d1a7"; // eslint-disable-line no-unused-vars
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1), __webpack_require__(0), __webpack_require__(17)))
...
exports.default = function (json, update, vis, force, node, link) {
    ...
    d3.select('#J_AddNode').on("click.add-node", function () {
        ...
        d3.select('.graph-area').on('click.add-node-ev', function () {
            ...
            d3.select("g#node-" + newNodeId).attr("transform", "translate(" + tx + "," + ty + ")").datum(Object.assign(d3.select("g#node-" + newNodeId).data()[0], {
                "x": tx,
                "y": ty
            }));
            force.stop();
...
var _templateWeb = __webpack_require__(18);
